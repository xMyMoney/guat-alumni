package com.zwx.guatalumni.common;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.zwx.guatalumni.module.activity");
        ...
        strategy.setInclude("activity","activity_record","activity_category");//对哪一张表生成代码
